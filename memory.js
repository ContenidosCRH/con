App = function()
{
    ...
    this.load = function()
    {
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/back2.jpg');
        ...
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/c1.jpg');
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/c2.jpg'); 
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/d1.jpg');
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/d2.jpg');
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/e1.jpg');
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/e2.jpg');
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/bg2.jpg');
        wade.loadImage('https://crh-concentrese.googlecode.com/git/images/sparkle.png');
        wade.preloadAudio('https://crh-concentrese.googlecode.com/git/sounds/right.ogg');
        wade.preloadAudio('https://crh-concentrese.googlecode.com/git/sounds/wrong.ogg');
    };
    ...
    this.createCard = function(i, j, delay)
    {
        ...
        setTimeout(function()
        {
            ...
            var sprite = new Sprite('https://crh-concentrese.googlecode.com/git/images/back2.jpg', 5);
            ...
            var animalSprite = new Sprite('https://crh-concentrese.googlecode.com/git/images/' + index + '.jpg', 10);
            ...
            card.onMouseUp = function()
            {
                ...
                else if (hiddenCards.length == 1)   // there is 1 card currently hidden
                {
                    ...
                    if (hiddenCards[0].animalIndex.substring(0, 1) == hiddenCards[1].animalIndex.substring(0, 1))
                    {
                        ...
                        wade.playAudioIfAvailable('https://crh-concentrese.googlecode.com/git/sounds/right.ogg');
                        if (++numMatches == 4)
                        {
                            setTimeout(function()
                            {
                    ...
                    else
                    {
                        ...
                        wade.playAudioIfAvailable('https://crh-concentrese.googlecode.com/git/sounds/wrong.ogg');
                        setTimeout(function()
                        {
    ...
    this.createParticle = function(position)
    {
        ...
        var animation = new Animation('https://crh-concentrese.googlecode.com/git/images/sparkle.png', 8, 4, 30);
